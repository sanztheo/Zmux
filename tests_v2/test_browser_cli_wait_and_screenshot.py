...
def _find_cli_binary() -> str:
    ...
    fixed = os.path.expanduser(
        "~/Library/Developer/Xcode/DerivedData/zmux-tests-v2/Build/Products/Debug/zmux"
    )
...
<!doctype html>
<html>
  <head><title>zmux-browser-cli-regression</title></head>
  <body>
    <main>
...
""".strip()
        ...
        out_dir = Path(tempfile.mkdtemp(prefix="zmux-browser-screenshot-cli-")) / "nested" / "dir"
