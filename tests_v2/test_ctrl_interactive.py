#!/usr/bin/env python3
"""
Interactive test for Ctrl+C and Ctrl+D in zmux terminal.

This script tests that control signals are properly handled.
Run this script inside the zmux terminal.
...
def main():
    print("=" * 50)
    print("zmux Control Signal Test")
    print("=" * 50)
    print("\nThis script tests if Ctrl+C and Ctrl+D work correctly.")
    print("Run this inside the zmux terminal to verify the fix.\n")
