...
final class KeyboardShortcutSettingsFileStoreTests: XCTestCase {
    ...
    private let settingsFileBackupsDefaultsKey = "zmux.settingsFile.backups.v1"
    ...
    func testBootstrapCreatesCommentedTemplateWhenPrimaryAndFallbackAreMissing() throws {
        ...
        let settingsFileURL = directoryURL
            .appendingPathComponent(".config/zmux", isDirectory: true)
        ...
        XCTAssertTrue(contents.contains(#""$schema": "https://raw.githubusercontent.com/manaflow-ai/zmux/main/web/data/zmux-settings.schema.json""#))
    ...
    func testSettingsFileStoreParsesJSONCCommentsAndTrailingCommas() throws {
        ...
        try writeSettingsFile(
            """
            {
              "$schema": "https://raw.githubusercontent.com/manaflow-ai/zmux/main/web/data/zmux-settings.schema.json",
              "schemaVersion": 1,
              // tmux-like prefix
              "shortcuts": {
                "bindings": {
...
final class StoredShortcutMatchingTests: XCTestCase {
    ...
    func testSystemWideHotkeyNormalizationReportsZmuxActionConflictByRecordedPhysicalKey() {
        KeyboardShortcutSettings.resetAll()
        defer { KeyboardShortcutSettings.resetAll() }
...
final class WorkspaceCreationConfigSanitizationTests: XCTestCase {
    private final class UnsafeConfigSnapshotTabManager: TabManager {
        private var injectedConfig: ZmuxSurfaceConfigTemplate?
        var capturedConfigTemplate: ZmuxSurfaceConfigTemplate?

        func installInjectedConfig(fontSize: Float) {
            var config = ZmuxSurfaceConfigTemplate()
            config.fontSize = fontSize
            config.workingDirectory = "/tmp/zmux-workspace-snapshot"
            config.command = "echo snapshot"
            config.environmentVariables = ["ZMUX_INHERITED_ENV": "1"]
...
final class WorkspaceSplitWorkingDirectoryTests: XCTestCase {
    ...
    func testNewTerminalSplitFallsBackToRequestedWorkingDirectoryWhenReportedDirectoryIsStale() {
        ...
        let requestedDirectory = "/tmp/zmux-requested-split-cwd-\(UUID().uuidString)"
...
final class WorkspacePanelGitBranchTests: XCTestCase {
    ...
    func testUpdatingFocusedPanelPullRequestWithSameStateDoesNotRepublishWorkspace() {
        ...
        let pullRequestURL = URL(string: "https://github.com/manaflow-ai/zmux/pull/2388")!
    ...
    func testSidebarPullRequestsTrackFocusedPanelOnly() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 1629,
            label: "PR",
            url: URL(string: "https://github.com/manaflow-ai/zmux/pull/1629")!,
            status: .open
        )
    ...
    func testSidebarDerivedCollectionsMatchWhenUsingPrecomputedPanelOrder() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 101,
            label: "PR",
            url: URL(string: "https://github.com/manaflow-ai/zmux/pull/101")!,
            status: .open
        )
        workspace.updatePanelPullRequest(
            ...
            number: 18,
            label: "MR",
            url: URL(string: "https://gitlab.com/manaflow/zmux/-/merge_requests/18")!,
            status: .merged
        )
