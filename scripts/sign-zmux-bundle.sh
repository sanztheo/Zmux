#!/usr/bin/env bash
# Inside-out codesign a zmux .app bundle for Developer ID + notarization.
#
# Usage:
#   scripts/sign-zmux-bundle.sh <app-path> <app-entitlements> <signing-identity>
#
# Example:
#   scripts/sign-zmux-bundle.sh \
#     "build-universal/Build/Products/Release/zmux NIGHTLY.app" \
#     zmux.nightly.entitlements \
#     "Developer ID Application: Manaflow, Inc. (7WLXT3NR37)"
#
# Optional env:
#   ZMUX_HELPER_ENTITLEMENTS  (default: zmux-helper.entitlements)
#   ZMUX_TIMESTAMP             set to "none" for un-timestamped local sigs
#
...
APP_ENTITLEMENTS="$2"
IDENTITY="$3"
HELPER_ENTITLEMENTS="${ZMUX_HELPER_ENTITLEMENTS:-zmux-helper.entitlements}"
