# Command Reference (zmux Markdown)

## Opening a Markdown Panel

```bash
zmux markdown open <path>
zmux markdown <path>          # shorthand (implicit "open")
```
...
|------|-------------|---------|
| `--workspace <id\|ref\|index>` | Target workspace | `$ZMUX_WORKSPACE_ID` |
...
zmux markdown open ./plan.md
zmux markdown open /Users/me/project/plan.md
```
