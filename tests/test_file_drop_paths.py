...
def wait_for_text(client: zmux, surface_id: str, needle: str, timeout: float = 3.0) -> bool:
...
def main() -> int:
    ...
    p1 = (tmp / "zmux drop [image] #1 (a).png").resolve()
    p2 = (tmp / "zmux drop second & file!.jpg").resolve()
