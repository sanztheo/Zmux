...
def test_goto_split_from_loaded_browser(client: zmux) -> tuple[bool, str]:
    """
...
def test_goto_split_roundtrip_loaded_browser(client: zmux) -> tuple[bool, str]:
    """
...
def run_tests() -> int:
    print("=" * 60)
    print("zmux Browser goto_split Regression Test")
    print("=" * 60)
    print()
    ...
    try:
        with zmux(socket_path=socket_path) as client:
