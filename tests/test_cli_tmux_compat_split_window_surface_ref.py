#!/usr/bin/env python3
"""
Regression tests for `zmux __tmux-compat split-window`.
"""
...
def run_cli(
    ...
    env["ZMUX_WORKSPACE_ID"] = "workspace:1"
    env["ZMUX_SURFACE_ID"] = "surface:1"
...
def main() -> int:
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="zmux-tmux-surface-ref-") as td:
            tmp = Path(td)
