#!/usr/bin/env python3
"""
Regression test: `zmux claude-teams --help` passes through to Claude.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="zmux-claude-teams-help-") as td:
        tmp = Path(td)
        home = tmp / "home"
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `zmux claude-teams --help` exited non-zero")
    ...
    print("PASS: zmux claude-teams forwards --help to Claude")
    return 0
