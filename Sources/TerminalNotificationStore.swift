...
extension UNUserNotificationCenter {
    private static let removalQueue = DispatchQueue(
        label: "com.zmuxterm.notification-removal",
        qos: .utility
    )
...
enum NotificationSoundSettings {
    ...
    private static let stagedCustomSoundBaseName = "zmux-custom-notification-sound"
    private static let customSoundPreparationQueue = DispatchQueue(
        label: "com.zmuxterm.notification-sound-preparation",
        qos: .utility
    )
    ...
    private static let customCommandQueue = DispatchQueue(
        label: "com.zmuxterm.notification-custom-command",
        qos: .utility
    )
    ...
    static func runCustomCommand(title: String, subtitle: String, body: String, defaults: UserDefaults = .standard) {
        ...
        customCommandQueue.async {
            ...
            env["ZMUX_NOTIFICATION_TITLE"] = title
            env["ZMUX_NOTIFICATION_SUBTITLE"] = subtitle
            env["ZMUX_NOTIFICATION_BODY"] = body
...
enum TaggedRunBadgeSettings {
    static let environmentKey = "ZMUX_TAG"
...
final class TerminalNotificationStore: ObservableObject {
    ...
    static let categoryIdentifier = "com.zmuxterm.app.userNotification"
    static let actionShowIdentifier = "com.zmuxterm.app.userNotification.show"
...
#if DEBUG
        zmuxDebugLog("notification.auth \(message)")
#endif
    ...
    func sendSettingsTestNotification() {
        ...
        ensureAuthorization(origin: .settingsTest) { [weak self] authorized in
            ...
            content.title = "zmux test notification"
            content.body = "Desktop notifications are enabled."
            content.sound = NotificationSoundSettings.sound()
            content.categoryIdentifier = Self.categoryIdentifier

            let request = UNNotificationRequest(
                identifier: "zmux.settings.test.\(UUID().uuidString)",
                content: content,
                trigger: nil
            )
    ...
    private func presentNotificationSettingsPrompt(attempt: Int) {
        ...
        alert.messageText = String(localized: "dialog.enableNotifications.title", defaultValue: "Enable Notifications for zmux")
        alert.informativeText = String(localized: "dialog.enableNotifications.message", defaultValue: "Notifications are disabled for zmux. Enable them in System Settings to see alerts.")
