    ...
    var body: some View {
        GeometryReader { geo in
            HStack(spacing: 4) {
                ...
                Button(action: {
                    #if DEBUG
                    zmuxDebugLog("browser.findbar.next panel=\(panelId.uuidString.prefix(5))")
                    #endif
                    onNext()
                }) {
                ...
                Button(action: {
                    #if DEBUG
                    zmuxDebugLog("browser.findbar.prev panel=\(panelId.uuidString.prefix(5))")
                    #endif
                    onPrevious()
                }) {
                ...
                Button(action: {
                    #if DEBUG
                    zmuxDebugLog("browser.findbar.close panel=\(panelId.uuidString.prefix(5))")
                    #endif
                    onClose()
                }) {
            ...
            .onAppear {
#if DEBUG
                zmuxDebugLog("browser.findbar.appear panel=\(panelId.uuidString.prefix(5))")
#endif
