...
final class UpdateLogStore {
    ...
    private let queue = DispatchQueue(label: "zmux.update.log")
    ...
    private init() {
        ...
        logURL = logsDir.appendingPathComponent("Logs/zmux-update.log")
        ensureLogFile()
    }
...
final class FocusLogStore {
    ...
    private let queue = DispatchQueue(label: "zmux.focus.log")
    private var entries: [String] = []
    ...
    private init() {
        ...
        let logsDir = FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask).first
            ?? FileManager.default.temporaryDirectory
        logURL = logsDir.appendingPathComponent("Logs/zmux-focus.log")
        ensureLogFile()
    }
