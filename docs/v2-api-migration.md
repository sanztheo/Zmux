...
- use a v2 JSON client (`tests_v2/zmux.py`)
- avoid depending on v1 text output formats

VM runners:
- v1: `ssh zmux-vm 'cd /Users/zmux/GhosttyTabs && ./scripts/run-tests-v1.sh'`
- v2: `ssh zmux-vm 'cd /Users/zmux/GhosttyTabs && ./scripts/run-tests-v2.sh'`
